...
public sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> b)
    {
        ...
        b.Property(x => x.Headers).HasMaxLength(4000);
        b.Property(x => x.LastError).HasMaxLength(4000);
        b.Property(x => x.CorrelationId).HasMaxLength(100);
        b.Property(x => x.CausationId).HasMaxLength(100);
        b.Property(x => x.AggregateType).HasMaxLength(200);
        b.Property(x => x.AggregateId).HasMaxLength(100);
        b.Property(x => x.ModuleName).HasMaxLength(100);
        b.Property(x => x.LockId).HasMaxLength(100);
        b.HasIndex(x => new { x.Status, x.NextAttemptOnUtc, x.LockedUntilUtc });
